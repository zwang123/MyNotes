...
% For example, the action of the symmetric group of X is transitive, the action of the general linear group or the special linear group of a vector space V on V ∖ {0} is transitive, but the action of the orthogonal group of a Euclidean space E is not transitive on E ∖ {0} (it is transitive on the unit sphere of E, though).
	...
	\href{http://math.uchicago.edu/~may/REU2020/Dannynotes.pdf}{NOTES ON FIBER BUNDLES}
	
	\href{https://www.math.uni-bielefeld.de/~tcutler/pdf/Partitions%20of%20Unity.pdf}{Partitions of Unity}
		
	\href{http://www.math.toronto.edu/selick/fibre.pdf}{ Fibre Bundles}
	
	\href{https://en.wikipedia.org/wiki/Vector_bundle}{vector bundle}
	
	\url{https://en.wikipedia.org/wiki/Tangent_bundle}
	
	\href{https://www.math.lsu.edu/~lawson/Chapter6.pdf}{immersions and embeddings}
	
	\url{https://math.stackexchange.com/questions/3468476/exercise-5-20-from-john-lees-ism-every-open-subset-of-a-immersed-submanifold}

	immersed always finer
	
	\subsubsection{Immersion}
	
	\url{https://en.wikipedia.org/wiki/Submersion_(mathematics)}
	

	\url{https://math.stackexchange.com/questions/1041579/is-it-possible-to-build-a-fiber-bundle-whose-fibers-are-different-or-we-should}
	
	\url{https://en.wikipedia.org/wiki/Homotopy_lifting_property}
	
	\url{https://en.wikipedia.org/wiki/Fibration}
